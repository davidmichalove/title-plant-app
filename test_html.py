...
try:
    ...
    with open("/Users/davidmichalove/Desktop/automate/app/TEST_DOCS/documentFrame.html", "w") as f:
        f.write(html)
        
    driver.save_screenshot(f"/Users/davidmichalove/Desktop/automate/app/TEST_DOCS/573_332_row1_loaded.png")
finally:
    driver.quit()

...
try:
    ...
    driver.switch_to.default_content()
    driver.switch_to.frame("bodyframe")
    inst_id = "451336" # the REAL inst_id for DEED 573/332
    ...
    for _ in range(120):
        ...
        elif any('451336' in f or 'DEED' in f.upper() or '197700137615' in f for f in files):
            print("Download finished!", [f for f in files if '451336' in f or 'DEED' in f.upper() or '197700137615' in f])
            break
finally:
    driver.quit()

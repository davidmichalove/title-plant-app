...
try:
    ...
    driver.switch_to.frame("docImgViewFrame") # Switch to docImgViewFrame
    
    html = driver.page_source
    with open("/Users/davidmichalove/Desktop/automate/app/TEST_DOCS/docImgViewFrame.html", "w") as f:
        f.write(html)
finally:
    driver.quit()

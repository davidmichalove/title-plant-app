...
try:
    ...
    time.sleep(10) # wait for download request to process
    
    driver.switch_to.default_content()
    driver.switch_to.frame("bodyframe")
    driver.switch_to.frame("dlframe")
    
    html = driver.page_source
    with open("/Users/davidmichalove/Desktop/automate/app/TEST_DOCS/dlframe.html", "w") as f:
        f.write(html)
finally:
    driver.quit()

...
1. Search Belmont County Kofile for Huntsman Ted (01/01/1980 - 08/24/2026).
2. Parallel download all unique documents (4 concurrent workers) into /Volumes/davidlls/assignments/test_huntsman_ted/.
3. Send all downloaded documents to Gemini 3.6 Flash for Lot 195 / Parcel 42-001138.000 + Mortgage Release cross-referencing.
...
SEARCH_NAME = "Huntsman Ted"
START_DATE = "01/01/1980"
END_DATE = "08/24/2026"
OUTPUT_DIR = "/Volumes/davidlls/assignments/test_huntsman_ted"
...
print(f"🎯 Target Tract: Lot 195 / Parcel 42-001138.000 (42-01138.000)")
print("=" * 80)
...
def analyze_pdf_with_gemini(pdf_path):
    ...
    try:
        ...
        2. Does this document reference Parcel ID "42-001138.000" (or "42-01138.000", "42-001138", "42-01138", "001138.000")?
        3. If this document is a MORTGAGE: Does it encumber Lot 195 or Parcel 42-001138.000?
        ...
        Return ONLY a JSON object with this exact structure:
        {
          ...
          "hit_reasons": ["List of matching criteria if hit, e.g. 'Conveys Lot 195', 'References Parcel 42-001138.000'"],
...
def main():
    ...
    with open(report_md_path, "w") as f:
        ...
        f.write(f"**Target Tract**: **Lot 195** / Parcel **`42-001138.000`** (`42-01138.000`)\n")
        ...
        f.write("## ⭐ Confirmed Hits (Affecting Lot 195 / Parcel 42-001138.000)\n\n")
        if confirmed_hits:
            ...
            f.write("No documents matched Lot 195 or Parcel 42-001138.000.\n\n")
